...
```python
from cashful.models.update_organization_compliance_internal_dto import UpdateOrganizationComplianceInternalDto

# TODO update the JSON string below
json = "{}"
# create an instance of UpdateOrganizationComplianceInternalDto from a JSON string
update_organization_compliance_internal_dto_instance = UpdateOrganizationComplianceInternalDto.from_json(json)
# print the JSON string representation of the object
print(UpdateOrganizationComplianceInternalDto.to_json())

# convert the object into a dict
update_organization_compliance_internal_dto_dict = update_organization_compliance_internal_dto_instance.to_dict()
# create an instance of UpdateOrganizationComplianceInternalDto from a dict
update_organization_compliance_internal_dto_from_dict = UpdateOrganizationComplianceInternalDto.from_dict(update_organization_compliance_internal_dto_dict)
```
