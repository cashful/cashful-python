...
[**retrieve_multiple_products**](ProductsApi.md#retrieve_multiple_products) | **POST** /api/canary/products/multiple | Retrieve Multiple Products by ID
...
# **retrieve_multiple_products**
> List[ProductResponseDto] retrieve_multiple_products(retrieve_multiple_products_dto)
...
with cashful.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = cashful.ProductsApi(api_client)
    retrieve_multiple_products_dto = cashful.RetrieveMultipleProductsDto() # RetrieveMultipleProductsDto | List of product IDs

    try:
        # Retrieve Multiple Products by ID
        api_response = api_instance.retrieve_multiple_products(retrieve_multiple_products_dto)
        print("The response of ProductsApi->retrieve_multiple_products:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProductsApi->retrieve_multiple_products: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **retrieve_multiple_products_dto** | [**RetrieveMultipleProductsDto**](RetrieveMultipleProductsDto.md)| List of product IDs | 
