...
class TestRetrieveMultipleProductsDto(unittest.TestCase):
    """RetrieveMultipleProductsDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RetrieveMultipleProductsDto:
        """Test RetrieveMultipleProductsDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RetrieveMultipleProductsDto`
        """
        model = RetrieveMultipleProductsDto()
        if include_optional:
    ...
    def testRetrieveMultipleProductsDto(self):
        """Test RetrieveMultipleProductsDto"""
