...
class TestCreateOrganizationComplianceDto(unittest.TestCase):
    """CreateOrganizationComplianceDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateOrganizationComplianceDto:
        """Test CreateOrganizationComplianceDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateOrganizationComplianceDto`
        """
        model = CreateOrganizationComplianceDto()
        if include_optional:
    ...
    def testCreateOrganizationComplianceDto(self):
        """Test CreateOrganizationComplianceDto"""
