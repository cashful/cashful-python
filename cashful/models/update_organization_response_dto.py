...
class UpdateOrganizationResponseDto(BaseModel):
    """
    UpdateOrganizationResponseDto
    """ # noqa: E501
    organization: OrganizationDto = Field(description="Organization updated successfully")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "organization": OrganizationDto.from_dict(obj["organization"]) if obj.get("organization") is not None else None
        })
        return _obj
