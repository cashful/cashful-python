...
class VerifyPhoneNumberDto(BaseModel):
    """
    VerifyPhoneNumberDto
    """ # noqa: E501
    phone_number: StrictStr = Field(description="The phone number to verify", alias="phoneNumber")
    code: StrictStr = Field(description="The OTP code received")
    __properties: ClassVar[List[str]] = ["phoneNumber", "code"]
