...
class CustomerBalanceDto(BaseModel):
    """
    CustomerBalanceDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "createdAt", "updatedAt", "deletedAt", "customerId", "merchantId", "amount", "currency", "available", "pending"]
