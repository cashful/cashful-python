...
class MerchantBalanceResponseDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "createdAt", "updatedAt", "deletedAt", "merchantId", "amount", "currency", "available", "pending"]
