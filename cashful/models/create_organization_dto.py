...
class CreateOrganizationDto(BaseModel):
    ...
    slug: StrictStr = Field(description="The slug of the organization")
    logo: Optional[StrictStr] = Field(default=None, description="The logo of the organization")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Metadata for the organization")
    __properties: ClassVar[List[str]] = ["name", "slug", "logo", "metadata"]
