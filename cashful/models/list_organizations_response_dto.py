...
class ListOrganizationsResponseDto(BaseModel):
    """
    ListOrganizationsResponseDto
    """ # noqa: E501
    data: List[OrganizationDto] = Field(description="List of organizations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [OrganizationDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
