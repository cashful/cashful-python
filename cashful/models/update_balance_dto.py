...
class UpdateBalanceDto(BaseModel):
    ...
    UpdateBalanceDto
    """ # noqa: E501
    amount: Union[StrictFloat, StrictInt] = Field(description="The amount to adjust the balance by")
    currency: Optional[StrictStr] = Field(default=None, description="The currency for the balance")
