...
class MemberDto(BaseModel):
    ...
    MemberDto
    """ # noqa: E501
    id: StrictStr = Field(description="Member ID")
    ...
    created_at: StrictStr = Field(description="Member creation date", alias="createdAt")
    __properties: ClassVar[List[str]] = ["id", "userId", "organizationId", "role", "createdAt"]
