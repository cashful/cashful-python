...
class GetActiveMemberResponseDto(BaseModel):
    """
    GetActiveMemberResponseDto
    """ # noqa: E501
    member: MemberDto = Field(description="Active member details")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "member": MemberDto.from_dict(obj["member"]) if obj.get("member") is not None else None
        })
        return _obj
