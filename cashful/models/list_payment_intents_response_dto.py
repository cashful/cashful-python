...
class ListPaymentIntentsResponseDto(BaseModel):
    """
    ListPaymentIntentsResponseDto
    """ # noqa: E501
    data: List[PaymentIntentResponseDto] = Field(description="List of payment intents")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PaymentIntentResponseDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "pagination": PaginationResponseDto.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })
        return _obj
