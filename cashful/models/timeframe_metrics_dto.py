...
class TimeframeMetricsDto(BaseModel):
    """
    TimeframeMetricsDto
    """ # noqa: E501
    ...
    breakdown: List[DailyBreakdownDto] = Field(description="Day-by-day breakdown for the last 30 days")
    __properties: ClassVar[List[str]] = ["daily", "weekly", "monthly", "breakdown"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "daily": MetricStatsDto.from_dict(obj["daily"]) if obj.get("daily") is not None else None,
            "weekly": MetricStatsDto.from_dict(obj["weekly"]) if obj.get("weekly") is not None else None,
            "monthly": MetricStatsDto.from_dict(obj["monthly"]) if obj.get("monthly") is not None else None,
            "breakdown": [DailyBreakdownDto.from_dict(_item) for _item in obj["breakdown"]] if obj.get("breakdown") is not None else None
        })
        return _obj
