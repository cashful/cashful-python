...
class NotificationDto(BaseModel):
    ...
    NotificationDto
    """ # noqa: E501
    channel: StrictStr = Field(description="Notification channel")
    email: Optional[SendEmailDto] = Field(default=None, description="Email notification data")
    sms: Optional[SendSmsDto] = Field(default=None, description="SMS notification data")
    __properties: ClassVar[List[str]] = ["channel", "email", "sms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "email": SendEmailDto.from_dict(obj["email"]) if obj.get("email") is not None else None,
            "sms": SendSmsDto.from_dict(obj["sms"]) if obj.get("sms") is not None else None
        })
        return _obj
