...
class AdminCreateUserDto(BaseModel):
    ...
    role: Optional[StrictStr] = Field(default=None, description="Optional role to assign to user")
    email_verified: Optional[StrictBool] = Field(default=None, description="Whether the user should be verified by default", alias="emailVerified")
