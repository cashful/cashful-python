...
class SessionUserDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "email", "emailVerified", "name", "image", "role", "banned", "banReason", "banExpires", "isAnonymous", "username", "displayUsername", "phoneNumber", "phoneNumberVerified", "createdAt", "updatedAt"]
