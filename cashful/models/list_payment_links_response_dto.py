...
class ListPaymentLinksResponseDto(BaseModel):
    """
    ListPaymentLinksResponseDto
    """ # noqa: E501
    data: List[PaymentLinkResponseDto]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PaymentLinkResponseDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
