...
class AdminSetUserPasswordDto(BaseModel):
    """
    AdminSetUserPasswordDto
    """ # noqa: E501
    user_id: StrictStr = Field(description="The ID of the user whose password to set", alias="userId")
    new_password: StrictStr = Field(description="The new password to set", alias="newPassword")
    __properties: ClassVar[List[str]] = ["userId", "newPassword"]
