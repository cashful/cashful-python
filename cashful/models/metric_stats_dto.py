...
class MetricStatsDto(BaseModel):
    ...
    MetricStatsDto
    """ # noqa: E501
    count: Union[StrictFloat, StrictInt] = Field(description="Count of items")
    sum: Union[StrictFloat, StrictInt] = Field(description="Sum of amounts in cents/smallest unit")
