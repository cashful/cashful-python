...
class UpdateMemberRoleDto(BaseModel):
    ...
    UpdateMemberRoleDto
    """ # noqa: E501
    member_id: StrictStr = Field(description="The ID of the member to update", alias="memberId")
    role: StrictStr = Field(description="The new role")
    organization_id: StrictStr = Field(description="The ID of the organization", alias="organizationId")
    __properties: ClassVar[List[str]] = ["memberId", "role", "organizationId"]
