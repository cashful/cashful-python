...
class CheckoutSessionConfirmResponseDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["sessionId", "paymentIntentId", "iveriParams", "iVeri3dsEndpoint", "sandboxMode", "status", "transactionId", "authCode", "amount", "currency", "reason"]
