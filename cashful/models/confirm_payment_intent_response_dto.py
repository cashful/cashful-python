...
class ConfirmPaymentIntentResponseDto(BaseModel):
    ...
    iveri_params: Optional[Dict[str, Any]] = Field(default=None, alias="iveriParams")
    i_veri3ds_endpoint: Optional[StrictStr] = Field(default=None, alias="iVeri3dsEndpoint")
    ...
    __properties: ClassVar[List[str]] = ["paymentIntent", "iveriParams", "iVeri3dsEndpoint", "sandboxMode", "status", "transactionId", "authCode", "amount", "currency", "reason"]
