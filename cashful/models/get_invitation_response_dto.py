...
class GetInvitationResponseDto(BaseModel):
    """
    GetInvitationResponseDto
    """ # noqa: E501
    invitation: InvitationDto = Field(description="Invitation details")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invitation": InvitationDto.from_dict(obj["invitation"]) if obj.get("invitation") is not None else None
        })
        return _obj
