...
class RejectInvitationDto(BaseModel):
    """
    RejectInvitationDto
    """ # noqa: E501
    invitation_id: StrictStr = Field(description="The ID of the invitation to reject", alias="invitationId")
    __properties: ClassVar[List[str]] = ["invitationId"]
