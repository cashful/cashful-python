...
class RefreshTokenDto(BaseModel):
    ...
    RefreshTokenDto
    """ # noqa: E501
    refresh_token: StrictStr = Field(description="The refresh token", alias="refreshToken")
    rotate: Optional[StrictBool] = Field(default=None, description="Whether to rotate the token")
    __properties: ClassVar[List[str]] = ["refreshToken", "rotate"]
