...
class UpdateOrganizationDto(BaseModel):
    ...
    """ # noqa: E501
    organization_id: StrictStr = Field(description="The ID of the organization to update", alias="organizationId")
    data: Dict[str, Any] = Field(description="Data to update")
    __properties: ClassVar[List[str]] = ["organizationId", "data"]
