...
class UpdateWebhookEndpointDto(BaseModel):
    ...
    events: Optional[List[StrictStr]] = Field(default=None, description="Array of event types to listen for")
    active: Optional[StrictBool] = Field(default=None, description="Whether the webhook endpoint is active")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Optional custom metadata")
    __properties: ClassVar[List[str]] = ["url", "events", "active", "metadata"]
