...
class ListUserInvitationsResponseDto(BaseModel):
    """
    ListUserInvitationsResponseDto
    """ # noqa: E501
    invitations: List[InvitationDto] = Field(description="List of user invitations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invitations": [InvitationDto.from_dict(_item) for _item in obj["invitations"]] if obj.get("invitations") is not None else None
        })
        return _obj
