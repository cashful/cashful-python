...
class OrganizationDto(BaseModel):
    ...
    logo: Optional[StrictStr] = Field(default=None, description="Organization logo")
    created_at: StrictStr = Field(description="Organization creation date", alias="createdAt")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Organization metadata")
    __properties: ClassVar[List[str]] = ["id", "name", "slug", "logo", "createdAt", "metadata"]
