...
class TransferResponseDto(BaseModel):
    ...
    from_customer_id: StrictStr = Field(alias="fromCustomerId")
    to_customer_id: StrictStr = Field(alias="toCustomerId")
    ...
    __properties: ClassVar[List[str]] = ["id", "merchantId", "fromCustomerId", "toCustomerId", "amount", "currency", "description", "status", "createdAt", "updatedAt"]
