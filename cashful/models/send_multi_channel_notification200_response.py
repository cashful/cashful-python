...
class SendMultiChannelNotification200Response(BaseModel):
    """
    SendMultiChannelNotification200Response
    """ # noqa: E501
    email: Optional[StrictStr] = Field(default=None, description="Email message ID")
    sms: Optional[StrictStr] = Field(default=None, description="SMS message ID")
