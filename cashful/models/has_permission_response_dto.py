...
class HasPermissionResponseDto(BaseModel):
    """
    HasPermissionResponseDto
    """ # noqa: E501
    has_permission: StrictBool = Field(description="Whether user has permission", alias="hasPermission")
    __properties: ClassVar[List[str]] = ["hasPermission"]
