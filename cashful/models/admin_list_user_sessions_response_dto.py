...
class AdminListUserSessionsResponseDto(BaseModel):
    """
    AdminListUserSessionsResponseDto
    """ # noqa: E501
    sessions: List[SessionDto] = Field(description="User sessions listed successfully")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sessions": [SessionDto.from_dict(_item) for _item in obj["sessions"]] if obj.get("sessions") is not None else None
        })
        return _obj
