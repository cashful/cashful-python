...
class CustomerPaymentMethodDto(BaseModel):
    """
    ...
    expiry_month: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="expiryMonth")
    expiry_year: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="expiryYear")
    is_default: Optional[StrictBool] = Field(default=None, alias="isDefault")
    __properties: ClassVar[List[str]] = ["id", "createdAt", "updatedAt", "deletedAt", "customerId", "type", "brand", "last4", "expiryMonth", "expiryYear", "isDefault"]
