...
class ListTransfersResponseDto(BaseModel):
    """
    ListTransfersResponseDto
    """ # noqa: E501
    data: List[TransferResponseDto] = Field(description="List of transfers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [TransferResponseDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
