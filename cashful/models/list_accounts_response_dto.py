...
class ListAccountsResponseDto(BaseModel):
    """
    ListAccountsResponseDto
    """ # noqa: E501
    accounts: List[LinkedAccountDto] = Field(description="List of linked social accounts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounts": [LinkedAccountDto.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None
        })
        return _obj
