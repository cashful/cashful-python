...
class GetAccessTokenResponseDto(BaseModel):
    """
    GetAccessTokenResponseDto
    """ # noqa: E501
    token: StrictStr = Field(description="Current access token")
    expires_at: Optional[StrictStr] = Field(default=None, description="Token expiration time", alias="expiresAt")
    __properties: ClassVar[List[str]] = ["token", "expiresAt"]
