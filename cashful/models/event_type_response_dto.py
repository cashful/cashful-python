...
class EventTypeResponseDto(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the event type")
    name: StrictStr = Field(description="Name of the event type")
    description: Optional[StrictStr] = Field(default=None, description="Description of the event type")
    is_active: StrictBool = Field(description="Whether the event type is active", alias="isActive")
